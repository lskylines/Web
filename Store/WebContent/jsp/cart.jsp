		...
		<div class="container">
			...
			<c:if test="${not empty cart.cartItems }">
					...
					<div style="margin-right:130px;">
						...
						登录后确认是否享有优惠&nbsp;&nbsp;
					</em> 商品金额: <em style="color:#ff6600;">${cart.total}</em>&nbsp; 赠送积分： <strong style="color:#ff6600;">￥${cart.total}元</strong>
						</div>
...
$(function(){
	$(".delete").click(function(){
		...
		if(flag){
			var pid = this.id;
			location.href="/Store/CartServlet?method=removeCartItem&id=" + pid;
		}
	});
});
...
$(function(){
	$("#clear").click(function(){
		if(confirm("确认清空购物车吗?")){
			location.href="/Store/CartServlet?method=clearCart";
		}
	});
});
</script>
