...
<script>
	$(function(){
		//向服务端发送Ajax请求，服务端经过处，将所有分类信息以JSON格式数据返回，获取所有分类信息
		var url = "/Store_v1/CategoryServlet";
		var obj = {"method": "findAllCats"};
		$.post(url, obj, function(data){
			//alert(data);
			//获取到服务端响应的数据，观察data存放的是一个json数据数组
			
			$.each(data, function(i, obj){
				var li = "<li><a href=/Store_v1/ProductServlet?method=findProductByCid&cid=" + obj.cid + ">" + obj.cname + "</a></li>";
				$("#myUL").append(li);		
			});
		}, "json");
	});
