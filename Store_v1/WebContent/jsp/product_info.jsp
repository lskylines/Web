		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<form id="myForm" method="post" action="${pageContext.request.contextPath}/CarServlet?method=addCartItemToCar">
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">商场价: <strong style="color:#ef0101;">￥：${product.shop_price }/份</strong> 市场价： <del>￥${product.market_price }元/份</del>
						</div>
	...
	<script>
		$(function(){
			$("#btnId").click(function(){
				...
				formObj.action="/Store_v1/CartServlet?method=addCartItemToCar";
				formObj.method="get";
				formObj.submit();
			});
		});
